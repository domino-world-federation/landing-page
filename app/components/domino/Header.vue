 ...
 *
 * The headline sharpens; nothing else moves.
 */
</script>
...
<template>
  ...
  >
    ...
    <!-- 480px wide with a 22px gap between the two (`119:4823`). `gap-[1.15vw]`
         is that 22 at the design width, with `gap-5` under it — the pair is two
         lines of type and the gap can shrink with them. -->
    <div
      class="flex w-full flex-col justify-end gap-5 lg:max-w-[480px] lg:gap-[1.15vw]"
    >
