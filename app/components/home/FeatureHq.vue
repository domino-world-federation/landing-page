...
<template>
  ...
  >
    ...
    <!-- Node `31:1105`: 870px wide at `x:525` — a column left of centre, clear
         ...
         kept; below `lg` the column starts at the section gutter, where there is
         no room to indent.
    ...
    >
      ...
      <MotionReveal :y="40" :delay="STAGGER" blur-from="8px">
        <p
          class="font-sans max-w-[680px] text-base leading-7 text-white lg:text-xl lg:leading-8"
        >
