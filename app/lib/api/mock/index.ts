...
export const MOCK_TOURNAMENT_DETAILS: TournamentDetail[] = MOCK_TOURNAMENTS.map(
  (tournament) => ({
    ...tournament,
    // The same pairing the tournament's collage reads, so the arrow and the
    // pictures above it always point at the same album.
    gallerySlug: MOCK_TOURNAMENT_ALBUMS[tournament.id],
...
export const MOCK_OLYMPIC_RESULTS: OlympicResult[] = [
  {
    ...
    federation: "Jamaica",
    eventDate: "Aug 14-17, 2025",
    location: "Miami, FL, United States",
    format: "Men\u2019s Singles \u2022 101 Points",
  },
  {
    id: "or2",
    year: "2025",
    ...
    federation: "Spain",
    eventDate: "Aug 18-20, 2025",
    location: "Miami, FL, United States",
    format: "Doubles \u2022 101 Points",
  },
  {
    id: "or3",
    year: "2025",
  ...
  },
  {
    id: "or4",
    year: "2024",
    event: "Mixed Doubles Domino",
    category: "Doubles",
    winners: "Ama Boateng & Kwesi Mensah",
    federation: "Ghana",
    eventDate: "Sep 2-5, 2024",
    location: "Accra, Ghana",
    format: "Mixed Doubles \u2022 101 Points",
  },
  {
    id: "or5",
    year: "2024",
    event: "Men\u2019s Team Domino",
    category: "Teams",
    winners: "Rep\u00fablica Dominicana",
    federation: "Dominican Republic",
  },
  {
    id: "or6",
    year: "2023",
    event: "Women\u2019s Doubles Domino",
    category: "Doubles",
    winners: "Nadia Haddad & Yasmin Karim",
    federation: "Morocco",
    eventDate: "Jul 21-24, 2023",
    location: "Casablanca, Morocco",
    format: "Women\u2019s Doubles \u2022 101 Points",
  },
  {
    id: "or7",
    year: "2023",
    event: "Open Singles Domino",
    category: "Singles",
    winners: "Hiroshi Tanaka",
    federation: "Japan",
  },
]
