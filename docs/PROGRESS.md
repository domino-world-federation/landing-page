...
| 2026-08-26 | Diverifikasi setelah pemindahan: `bunx next build` dari `landing-page/` lolos, 16 halaman, 14 rute — sama seperti sebelum pindah; `bunx tsc --noEmit` dan `bunx eslint` bersih. `.next/` lama dihapus, jadi `LayoutProps` (tipe generated Next) sempat hilang sampai build meregenerasinya |
